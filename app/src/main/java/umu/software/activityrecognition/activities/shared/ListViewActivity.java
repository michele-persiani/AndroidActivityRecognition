 ...
 */
public abstract class ListViewActivity extends WearActivity
{
    ...
    {
        RecyclerView recyclerView = findViewById(R.id.listView);
        recyclerView.swapAdapter(new ListViewActivity.Adapter(), true);
    }
    ...
    /**
     * Creates a view for an entry. All entries get their view created through this method.
