 ...
 */
public abstract class PreferencesBuilder implements Consumer<SharedPreferences>
{
    ...
    public static PreferencesBuilder newInstance(Consumer<PreferencesBuilder> builder)
    {
