...
public class BaseRecognitionListener implements RecognitionListener
{
    ...
    protected void onRecognizedSpeech(@Nullable  List<Pair<String, Float>> results)
    {
    }

    protected void onRecognizedPartialSpeech(@Nullable List<Pair<String, Float>> results)
    {
    }
